/**
 * Site Contacts Management Modal
 * Allows adding/removing contacts from a site
 */
...
export const SiteContactsModal = ({
  siteName,
  isOpen,
  onClose,
  assignedContacts = [],
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-screen overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Manage Site Contacts</DialogTitle>
          <DialogDescription>
            {siteName && `Managing contacts for ${siteName}`}
          </DialogDescription>
        </DialogHeader>
